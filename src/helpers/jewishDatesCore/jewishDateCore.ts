 ...
 * @copyright github.com/Shmulik-Kravitz. Repo Name: react-jewish-datepicker
 * @license GPL-3.0
 */

import hebrewDateN from 'hebrew-date';
import * as HeDate from '@hebcal/core';
import gematriya from 'gematriya';
import dayjs from 'dayjs';
import type { JewishDate, JewishDay, JewishMonthInfo, JewishMonth, BasicJewishMonthInfo, IdText, BasicJewishDate } from './interfaces';
const hebrewDate = hebrewDateN;
